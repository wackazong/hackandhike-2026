...
//! intended core.
//!
//! - CPU0 owns application/model coordination, presentation state, display I/O,
//!   and the application side of semantic cross-core communication.
...
use crate::{audio, cross_core, display, network, system_i2c};
