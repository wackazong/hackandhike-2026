...
mod generated {
    use embedded_gui::prelude::*;
    embedded_gui::include_gui!("src/bin/demo/views/imu_worldview/view/imu.kdl");
}
    ...
    pub(crate) fn present(
            ...
            || north_dot.map(|dot| dot < BASIS_JUMP_DOT).unwrap_or(false)
        {
            ::log::warn!(
                ...
                imu.gravity_screen[0],
                imu.gravity_screen[1],
                imu.gravity_screen[2],
                imu.north_screen[0],
                imu.north_screen[1],
                imu.north_screen[2],
                imu.roll_deg,
        ...
        if self
            .trace_frames
            .is_multiple_of(WORLDVIEW_TRACE_EVERY_FRAMES)
        {
            ::log::trace!(
