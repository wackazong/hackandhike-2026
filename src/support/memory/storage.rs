...
//! construction and then operates within a fixed bound. Runtime handles,
//! synchronization objects, stacks, atomics, and DMA descriptors remain in
//! internal RAM.
...
/// Fixed-size PSRAM-backed storage. Capacity is established once and never changes.
